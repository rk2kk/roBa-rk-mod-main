...
なおMX版3Dプリントケースはkumakeyさんが[github](https://github.com/kumamuk-git/roBa/tree/main/case/v2)上で公開しています。  
...
![alt text](img/switch.jpg)

> [!caution]
> 基板からはみ出したピンは、はんだで固定する前にカットしてください。

裏面からピンを差し込み、マスキングで仮止めします。  
